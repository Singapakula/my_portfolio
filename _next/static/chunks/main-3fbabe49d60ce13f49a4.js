    ...
    [4], {
        ...
        IKlv: function(e, t, r) {
            ...
            var C = function(e) {
                ...
                G = A.defaultLocale,
                W = D || "";
            r.p = "".concat(W, "/_next/"), E.setConfig({
                serverRuntimeConfig: {},
            ...
            var ee, te = function(e) {
                    ...
                    return i(r, [{
                        ...
                        value: function() {
                            this.scrollToHash(), z.isSsr && (B || A.nextExport && ((0, w.isDynamicRoute)(z.pathname) || location.search) || M && M.__N_SSG && location.search) && z.replace(z.pathname + "?" + String(_.assign(_.urlQueryToSearchParams(z.query), new URLSearchParams(location.search))), J, {
                                _h: 1,
                                shallow: !B
                            })
                        }
                ...
                var e = o(n.mark((function e() {
                    ...
                    return n.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return s.length > 0 && void 0 !== s[0] ? s[0] : {}, e.next = 4, U.routeLoader.whenEntrypoint("/_app");
                            case 4:
                                ...
                                throw r.error;
                            case 7:
                                o = r.component, a = r.exports, Q = o, a && a.reportWebVitals && (Z = function(e) {
                                    var t, r = e.id,
                                        n = e.name,
                                        o = e.startTime,
                                        i = e.value,
                            ...
                            case 36:
                                return t.router = z = (0, k.createRouter)(R, F, J, {
                                    initialProps: M,
                                    pageLoader: U,
                                    App: Q,
                                    Component: ee,
            ...
            function ae() {
                return (ae = o(n.mark((function e(t) {
                    return n.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (!t.err) {
            ...
            function ie(e) {
                var t = e.App,
                    r = e.err;
                return console.error(r), U.loadPage("/_error").then((function(n) {
                    var o = n.page,
                        a = n.styleSheets,
                        i = de(t),
                        u = {
                    ...
                    callback: function() {
                        if (a && !c) {
                            for (var t = new Set(a.map((function(e) {
                                    return e.href
                                }))), r = C(document.querySelectorAll("style[data-n-href]")), n = r.map((function(e) {
                    ...
                    value: function(e, t, r, n) {
                        var o = this,
                            ...
                            v = function(e) {
                                ...
                                return (0, u.addBasePath)("/_next/data/".concat(o.buildId).concat(t).concat(r ? "" : d))
                            },
